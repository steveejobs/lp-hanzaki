...
import type { HanzakiMediaAsset } from "@/src/data/hanzaki-media";

type InstagramMediaMarqueeProps = {
  media: HanzakiMediaAsset[];
};

export function InstagramMediaMarquee({ media }: InstagramMediaMarqueeProps) {
  return (
    <section className="ig-rise mt-5 overflow-hidden" aria-label="Vitrine Hanzaki">
